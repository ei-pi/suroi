...
import { COLORS, UI_DEBUG_MODE, HITBOX_DEBUG_MODE, HITBOX_COLORS, PIXI_SCALE } from "../utils/constants";
...
export class Player extends GameObject<ObjectCategory.Player> {
    ...
    constructor(game: Game, id: number, data: Required<ObjectsNetData[ObjectCategory.Player]>) {
        ...
        this.images = {
            // SuroiSprite().setFrame("aimTrail").setVisible(false).setZIndex(1000).setAngle(90).setPos(1800,0)
            aimTrail: new TilingSprite(Texture.from("aimTrail.svg"), 20, 6000),
